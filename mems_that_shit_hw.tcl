...
add_parameter DATA_TO_REG STD_LOGIC_VECTOR 2
set_parameter_property DATA_TO_REG DEFAULT_VALUE 2
set_parameter_property DATA_TO_REG DISPLAY_NAME DATA_TO_REG
set_parameter_property DATA_TO_REG WIDTH 4
set_parameter_property DATA_TO_REG TYPE STD_LOGIC_VECTOR
set_parameter_property DATA_TO_REG UNITS None
set_parameter_property DATA_TO_REG ALLOWED_RANGES 0:15
set_parameter_property DATA_TO_REG HDL_PARAMETER true
add_parameter FILTER STD_LOGIC_VECTOR 3
set_parameter_property FILTER DEFAULT_VALUE 3
set_parameter_property FILTER DISPLAY_NAME FILTER
set_parameter_property FILTER WIDTH 4
set_parameter_property FILTER TYPE STD_LOGIC_VECTOR
set_parameter_property FILTER UNITS None
set_parameter_property FILTER ALLOWED_RANGES 0:15
set_parameter_property FILTER HDL_PARAMETER true
add_parameter DECIMATION STD_LOGIC_VECTOR 4
set_parameter_property DECIMATION DEFAULT_VALUE 4
set_parameter_property DECIMATION DISPLAY_NAME DECIMATION
set_parameter_property DECIMATION WIDTH 4
set_parameter_property DECIMATION TYPE STD_LOGIC_VECTOR
set_parameter_property DECIMATION UNITS None
set_parameter_property DECIMATION ALLOWED_RANGES 0:15
set_parameter_property DECIMATION HDL_PARAMETER true
add_parameter TRANSMIT STD_LOGIC_VECTOR 5
set_parameter_property TRANSMIT DEFAULT_VALUE 5
set_parameter_property TRANSMIT DISPLAY_NAME TRANSMIT
set_parameter_property TRANSMIT WIDTH 4
set_parameter_property TRANSMIT TYPE STD_LOGIC_VECTOR
set_parameter_property TRANSMIT UNITS None
set_parameter_property TRANSMIT ALLOWED_RANGES 0:15
set_parameter_property TRANSMIT HDL_PARAMETER true
