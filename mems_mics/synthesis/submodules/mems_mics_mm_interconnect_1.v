...
module mems_mics_mm_interconnect_1 (
	...
	mems_mics_mm_interconnect_1_router router (
	...
	mems_mics_mm_interconnect_1_router_001 router_001 (
	...
	mems_mics_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	mems_mics_mm_interconnect_1_cmd_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                           //       clk.clk
		.reset              (onchip_memory2_0_reset1_reset_bridge_in_reset_reset),     // clk_reset.reset
	...
	mems_mics_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                       //       clk.clk
		.reset               (onchip_memory2_0_reset1_reset_bridge_in_reset_reset), // clk_reset.reset
